...
PRJLR__=W5E5            # Project name of LR__ simulation (Manual Ch.8,9)
RUNLR__=LR__            # Run     name of LR__ simulation (Manual Ch.8,9)
PRJ__C_=W5E5            # Project name of __C_ simulation (Manual Ch.10)
RUN__C_=__C_            # Run     name of __C_ simulation (Manual Ch.10)
PRJN_C_=W5E5            # Project name of N_C_ simulation (Manual Ch.13)
